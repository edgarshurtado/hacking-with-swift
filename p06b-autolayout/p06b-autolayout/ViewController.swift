...
//  p06b-autolayout
//
//  Created by Edgar Sánchez Hurtado on 18/5/23.
//
...
class ViewController: UIViewController {
    override func viewDidLoad() {
        ...
        autoLayoutWithAnchors(label1: label1, label2: label2, label3: label3, label4: label4, label5: label5)
        
    }
    
    func autoLayoutWithVFL(label1: UILabel, label2: UILabel, label3: UILabel, label4: UILabel, label5: UILabel) {
